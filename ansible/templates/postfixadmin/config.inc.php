...
$CONF['setup_password'] = '{{ postfixadmin.setup_password }}';
...
// mysqli = MySQL 4.1+ 
// pgsql = PostgreSQL
$CONF['database_type'] = '{{ database.provider }}';
$CONF['database_host'] = '{{ database.host }}:{{ database.port }}';
$CONF['database_user'] = '{{ database.user }}';
$CONF['database_password'] = '{{ database.password }}';
$CONF['database_name'] = '{{ database.name }}';
